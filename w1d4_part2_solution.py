...
# Has some nice graphs on correlations between hyperparameters: https://myrtle.ai/learn/how-to-train-your-resnet-5-hyperparameters/
# "Bag of Tricks" notebook with various cool ideas: https://github.com/davidcpage/cifar10-fast/blob/master/bag_of_tricks.ipynb
...
def train(config_dict: dict[str, Any]):
    ...
    testloader = DataLoader(cifar_test, batch_size=1024, pin_memory=True)  # Can set to fit GPU memory
