# %%
# credit to https://github.com/vojtamolda/reinforcement-learning-an-introduction/blob/main/chapter02/bandit.py
"""
...
class MultiArmedBandit(gym.Env):
    ...
    def step(self, arm: ActType) -> tuple[ObsType, float, bool, dict]:
        ...
        if not self.stationary:
            ...
            # Best may have changed after the drift
    ...
    def render(self, mode="human"):
        ...
        for arm in range(self.action_space.n):
            bandit_samples += [np.random.normal(loc=self.arm_reward_means[arm], scale=1.0, size=1_000)]
...
def run_episode(env: gym.Env, agent: Agent, seed: int):
    ...
    while not done:
        ...
        was_best.append(1 if arm == info["best_arm"] else 0)  # type: ignore
