# Taken from https://myrtle.ai/learn/how-to-train-your-resnet-1-baseline/
import torch
...
def label_smoothing_loss(inputs, targets, alpha):
    log_probs = F.log_softmax(inputs, dim=1, _stacklevel=5)
...
def patch_whitening(data, patch_size=(3, 3)):
    ...
    # is close to 1.
    # TBD: explain this better and doc the shape
    h, w = patch_size
    c = data.size(1)
